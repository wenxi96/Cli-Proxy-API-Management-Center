...
- 规范 `.agents` 路径：`.agents/`
- 当前执行面：主工作树
- 当前活跃任务入口：`tasks/20260709-frontend-usage-token-cost-detail-v2/task.md`

## 当前活跃任务

- `tasks/20260715-frontend-upstream-v1-18-3-absorption/`：前端 `v1.18.3` 已提交并推送 `dev@41ad444`，当前等待代码合入 `master` 的单独授权。
