...
export const SECTION_VALIDATION_FIELDS: Record<VisualSectionId, readonly VisualConfigFieldPath[]> =
  {
    ...
    quota: ['quotaAutoDisableAuthFileQuotaThresholdPercent'],
    streaming: [
...
export const FIELD_VALUE_KEYS: Record<string, readonly string[]> = {
  ...
  routingScopedPoolEnabled: ['routingScopedPoolEnabled'],
  routingScopedPoolDefaultsLimit: ['routingScopedPoolDefaultsLimit'],
  routingScopedPoolDefaultsQuotaThresholdPercent: ['routingScopedPoolDefaultsQuotaThresholdPercent'],
  routingScopedPoolDefaultsConsecutiveErrorThreshold: [
    'routingScopedPoolDefaultsConsecutiveErrorThreshold',
  ],
  routingScopedPoolDefaultsPenaltyWindowSeconds: ['routingScopedPoolDefaultsPenaltyWindowSeconds'],
  routingScopedPoolDefaultsQuotaSnapshotTTLSeconds: [
    'routingScopedPoolDefaultsQuotaSnapshotTTLSeconds',
  ],
  routingScopedPoolDefaultsIdleLogThrottleSeconds: [
  ...
  routingScopedPoolProviders: ['routingScopedPoolProviders'],
  ...
  quotaAutoDisableAuthFileOnLowQuota: ['quotaAutoDisableAuthFileOnLowQuota'],
