    ...
    <form id={formId} className={styles.form} onSubmit={handleSubmit} noValidate>
      ...
      {descriptor.supportsApiKeyEntries && form.apiKeyEntries ? (
        <Collapsible
          ...
          hint={`${apiKeyEntries.filter((e) => e.apiKey.trim() || e.authIndex?.trim()).length}`}
          defaultOpen
        >
                ...
                <div key={idx} className={styles.entryCard}>
                  ...
                  <div className={styles.field}>
                    <label className={styles.label}>
                      ...
                      <span className={styles.labelHint}>
                        {' '}
                        · {t('providersPage.form.apiKeyOrAuthIndexHint')}
                      </span>
                    </label>
                    <input
                      className={styles.input}
                  ...
                  <div className={styles.field}>
                    <label className={styles.label}>
                      {t('providersPage.form.authIndex')}
                    </label>
                    <input
                      className={styles.input}
                      ...
                      onChange={(e) =>
                        updateField(
                          'apiKeyEntries',
                          apiKeyEntries.map((it, i) =>
                            i === idx ? { ...it, authIndex: e.target.value } : it
                          )
                        )
                      }
                      disabled={mutating}
