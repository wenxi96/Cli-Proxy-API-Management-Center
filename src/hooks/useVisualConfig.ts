  ...
  const loadVisualValuesFromYaml = useCallback((yamlContent: string) => {
    try {
      ...
      const newValues: VisualConfigValues = {
        ...
        routingScopedPoolDefaultsLimit: parseScopedPoolNumber(asRecord(scopedPool?.defaults)?.limit),
      ...
      try {
        ...
        if (
          ...
          if (
            ...
            } else if (docHas(doc, ['routing', 'scoped-pool', 'defaults'])) {
              doc.deleteIn(['routing', 'scoped-pool', 'defaults']);
            }
