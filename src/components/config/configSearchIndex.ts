...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'routingScopedPoolEnabled',
    sectionId: 'network',
    labelKey: L('sections.network.scoped_pool_enabled'),
    hintKey: L('sections.network.scoped_pool_enabled_desc'),
    yamlKeys: ['routing', 'scoped-pool', 'enabled'],
    keywords: ['scoped pool', 'provider pool', 'round-robin'],
  },
  {
    fieldId: 'routingScopedPoolDefaultsLimit',
    sectionId: 'network',
    labelKey: L('sections.network.scoped_pool_defaults_limit'),
    yamlKeys: ['routing', 'scoped-pool', 'defaults', 'limit'],
    keywords: ['scoped pool', 'pool limit'],
  },
  {
    fieldId: 'routingScopedPoolDefaultsQuotaThresholdPercent',
    sectionId: 'network',
    labelKey: L('sections.network.scoped_pool_defaults_quota_threshold_percent'),
    hintKey: L('sections.network.scoped_pool_defaults_quota_threshold_percent_hint'),
    yamlKeys: ['routing', 'scoped-pool', 'defaults', 'quota-threshold-percent'],
    keywords: ['scoped pool', 'quota threshold'],
  },
  {
    fieldId: 'routingScopedPoolDefaultsConsecutiveErrorThreshold',
    sectionId: 'network',
    labelKey: L('sections.network.scoped_pool_defaults_consecutive_error_threshold'),
    yamlKeys: ['routing', 'scoped-pool', 'defaults', 'consecutive-error-threshold'],
    keywords: ['scoped pool', 'error threshold'],
  },
  {
    fieldId: 'routingScopedPoolDefaultsPenaltyWindowSeconds',
    sectionId: 'network',
    labelKey: L('sections.network.scoped_pool_defaults_penalty_window_seconds'),
    yamlKeys: ['routing', 'scoped-pool', 'defaults', 'penalty-window-seconds'],
    keywords: ['scoped pool', 'penalty window'],
  },
  {
    fieldId: 'routingScopedPoolDefaultsQuotaSnapshotTTLSeconds',
    sectionId: 'network',
    labelKey: L('sections.network.scoped_pool_defaults_quota_snapshot_ttl_seconds'),
    yamlKeys: ['routing', 'scoped-pool', 'defaults', 'quota-snapshot-ttl-seconds'],
    keywords: ['scoped pool', 'quota snapshot ttl'],
  },
  {
    fieldId: 'routingScopedPoolDefaultsIdleLogThrottleSeconds',
    sectionId: 'network',
    labelKey: L('sections.network.scoped_pool_defaults_idle_log_throttle_seconds'),
    yamlKeys: ['routing', 'scoped-pool', 'defaults', 'idle-log-throttle-seconds'],
    keywords: ['scoped pool', 'idle log throttle'],
  },
  {
    fieldId: 'routingScopedPoolProviders',
    sectionId: 'network',
    labelKey: L('sections.network.scoped_pool_providers_title'),
    hintKey: L('sections.network.scoped_pool_providers_desc'),
    yamlKeys: ['routing', 'scoped-pool', 'providers'],
    keywords: ['scoped pool', 'provider overrides'],
  },
  {
  ...
  },
  {
    ...
    sectionId: 'quota',
    labelKey: L('sections.quota.auto_disable_threshold_percent'),
    hintKey: L('sections.quota.auto_disable_threshold_percent_hint'),
    yamlKeys: ['quota-exceeded', 'auto-disable-auth-file-quota-threshold-percent'],
    keywords: ['auto disable', 'auth file', 'quota threshold'],
  },
  {
